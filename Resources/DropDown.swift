...
//  uia
//
//  Created by EMPULSE on 27/09/23.
//
...
class DropdownView: UIView {
    ...
    private func commonInit() {
        // Customize the appearance and behavior of the dropdown view
        titleLabel.textColor = UIColor.black
        titleLabel.textAlignment = .center

        // Add tap gesture to handle dropdown toggle
...
//            tableView.bottomAnchor.constraint(equalTo: self.bottomAnchor),
        ...
        // Create a dynamic height constraint for the table view
    ...
    @objc private func didTapDropdown() {
        ...
        if isDropdownOpen, let containerView = containerView {
    ...
    private func updateTableViewHeight() {
        if isDropdownOpen {
            let rowCount = options.count
            let maxHeight: CGFloat = 150 // Maximum height for the dropdown
            let rowHeight: CGFloat = 44 // Adjust this based on your cell height
            let newHeight = min(CGFloat(rowCount) * rowHeight, maxHeight)
